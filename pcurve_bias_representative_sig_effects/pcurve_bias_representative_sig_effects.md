...
## 
## tau^2 (estimated amount of total heterogeneity): 0.0390 (SE = 0.0013)
## tau (square root of estimated tau^2 value):  0.1974
## 
## Model Results:
## 
##           estimate std.error z-stat      p-val  ci.lb  ci.ub
## Intercept   0.3997  0.003085  129.6 < 2.22e-16 0.3937 0.4058
## 
## Adjusted Model (k = 10000):
## 
## tau^2 (estimated amount of total heterogeneity): 0.0389 (SE = 0.0013)
## tau (square root of estimated tau^2 value):  0.1971
## 
## Model Results:
## 
##               estimate std.error z-stat      p-val  ci.lb  ci.ub
## Intercept       0.3968  0.004928  80.53 < 2.22e-16 0.3872 0.4065
## 0.025 < p < 1   0.9749  0.032716  29.80 < 2.22e-16 0.9108 1.0390
## 
## Likelihood Ratio Test:
## X^2(df = 1) = 0.5751226, p-val = 0.44823
## 
## Number of Effect Sizes per Interval:
## 
##                      Frequency
## p-values <0.025           4221
## 0.025 < p-values < 1      5779
```
...
## 
##           estimate std.error z-stat      p-val  ci.lb ci.ub
## Intercept   0.6384  0.003403  187.6 < 2.22e-16 0.6317 0.645
## 
## Adjusted Model (k = 4221):
## 
## tau^2 (estimated amount of total heterogeneity): 0.0226 (SE = 0.0018)
## tau (square root of estimated tau^2 value):  0.1505
## 
## Model Results:
## 
##               estimate std.error z-stat      p-val  ci.lb  ci.ub
## Intercept       0.4631   0.00345  134.2 < 2.22e-16 0.4563 0.4699
## 0.025 < p < 1   0.0100       NaN    NaN         NA    NaN    NaN
## 
## Likelihood Ratio Test:
## X^2(df = 1) = 2869.076, p-val = < 2.22e-16
## 
## Number of Effect Sizes per Interval:
## 
##                      Frequency
...
> the estimate is upwardly biased, as the methodologists say, but not as upward as *p*-curve's estimate

# Conclusion: bias from simulations versus "real-world" bias

McShane et al. are right to recommend people use valuable information from effect sizes, *p* < .05 or not. What's more, the model they recommend does just as well as *p*-curve when only *p* < .05 are published—in my example but also in McShane et al.'s simulations.
